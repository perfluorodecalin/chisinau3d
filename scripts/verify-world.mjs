...
console.log(JSON.stringify({chunks:ids.size,meshes,triangles,buildings,obstacles,streets,compressedMB:Math.round(bytes/1048576),lodChunks:manifest.lodChunks.length,lodBuildings,lodRoads,lodTerrain,lodCompressedMB:Math.round(lodBytes/1048576)},null,2));
