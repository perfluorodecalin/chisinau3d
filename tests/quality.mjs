...
const scene=new T.Scene();const terrain=await loadTerrain(scene);assert.ok(scene.children.length>100);assert.equal(scene.children.reduce((n,m)=>n+m.geometry.index.count/3,0),(terrain.meta.nx-1)*(terrain.meta.nz-1)*2);
